...
@SET coverage_filter=+[Serilog.Extensions.WebJobs*]* -[*.Tests]*
@SET coverage_results=%results_path%\Test.Coverage.xml

@IF NOT EXIST "%results_path%" MD "%results_path%"

@echo dotnet build --configuration %config% "%~dp0test\Serilog.Extensions.WebJobs.Tests\Serilog.Extensions.WebJobs.Tests.csproj"
@dotnet build --configuration %config% "%~dp0test\Serilog.Extensions.WebJobs.Tests\Serilog.Extensions.WebJobs.Tests.csproj"

cd "%~dp0test\Serilog.Extensions.WebJobs.Tests"
